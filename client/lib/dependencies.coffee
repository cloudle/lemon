...
lemon.dependencies.add 'productManagement', ['merchantEssential', 'availableProducts']
...
lemon.dependencies.add 'merchantReport', ['merchantEssential', 'merchantReportData', 'availableBranch']
