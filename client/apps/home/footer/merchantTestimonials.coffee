...
,
  ...
  avatar: -> 'a.phuong.jpg'
  comment: -> "Bạn sẽ cảm thấy may mắn khi đối thủ của mình chưa biết tới EDS, nó là công cụ tạo ra sự khác biệt cho doanh
               nghiệp của bạn, tôi đang dùng EDS để quản lý việc kinh doanh của gia đình từ nước ngoài, tôi cá là bạn cũng sẽ
               bị ấn tượng bởi chức năng trò chuyện công việc của EDS giống như tôi."
,
