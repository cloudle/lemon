...
#  Session.set('genderNewStock', true)
#  scope.genderSelectOptions =
#    query: (query) -> query.callback
#      results: Apps.Merchant.GenderTypes
#      text: 'id'
#    initSelection: (element, callback) ->
#      callback _.findWhere(Apps.Merchant.GenderTypes, {_id: Session.get('genderNewStock')})
#    reactiveValueGetter: -> _.findWhere(Apps.Merchant.GenderTypes, {_id: Session.get('genderNewStock')})
#    changeAction: (e) ->
#      Session.set('genderNewStock', e.added._id)
